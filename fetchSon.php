...
<body>
	...
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Sight Details- Sonmarg</h1>
	</div>
</div>
<!-- top-header -->
...
<?php 
$sql = "SELECT * from sightseeing where city='Sonamarg'";
