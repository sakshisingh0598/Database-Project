...
<script src="js/jquery-ui.js"></script>
	 ...
	 #header{
        background:url(https://images.unsplash.com/photo-1474770337042-bd7e2ccb4f39?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1790&q=80);
...
<body>
	...
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Sight Details- Pahalgam</h1>
	</div>
</div>
<!-- top-header -->
...
<?php 
$sql = "SELECT * from sightseeing where city='Pahalgam'";
...
<form name="book" method="post">
		<div class="selectroom_top white">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p><b>Sight Details :</b> <?php echo htmlentities($result->details);?></p>
